...
качественных структурных блоков, и вообще всего, относящегося к творческому процессу формирования обратной связи, который можно подвести под [стандарты понимания качества](./feedback.md) с позиции методиста Отус.
